...
export const SellerDashboard = () => {
  ...
  const stats = [
    ...
    { label: 'Total Revenue', value: `$${totalRevenue.toFixed(2)}`, icon: DollarSign, color: 'text-purple-600', bg: 'bg-purple-100' },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8" data-testid="seller-dashboard">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <h1 className="text-3xl font-bold text-slate-900 mb-8" style={{ fontFamily: 'Manrope, sans-serif' }}>Seller Dashboard</h1>
